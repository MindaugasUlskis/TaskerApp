...
const tasks: Task[] = [
  { jobCategory: 'Plumbing', dateCreated: '05/01/2023', status: 'Completed', address: '123 Main St.',city: 'Vilnius', cost: 100, notes: 'Skalbimo mašina pakraunama iš priekio Ströme WM1510/01', started: '15/05/2023 12:10' },
  { jobCategory: 'Electrical', dateCreated: '05/02/2023', status: 'In Progress', address: '456 Oak Ave.',city: 'Vilnius', cost: 200, notes: 'Televizorius Sony KD50X72KPAEP Android LED TV, 50" (~127 cm)', started: '15/05/2023 12:00'},
  { jobCategory: 'Carpentry', dateCreated: '05/03/2023', status: 'Pending', address: '789 Maple St.',city: 'Klaipėda', cost: 150, notes: 'Spinta Denver, balta Prekės ID: 6697566' },
  { jobCategory: 'Plumbing', dateCreated: '05/01/2023', status: 'Completed', address: '123 Main St.',city: 'Vilnius', cost: 120, notes: 'Skalbimo mašina pakraunama iš priekio Ströme WM1510/01', started: '15/05/2023 12:10' },
  { jobCategory: 'Electrical', dateCreated: '05/02/2023', status: 'In Progress', address: '456 Oak Ave.',city: 'Kaunas', cost: 180, notes: 'Televizorius Sony KD50X72KPAEP Android LED TV, 50" (~127 cm)', started: '15/05/2023 12:00' },
  { jobCategory: 'Carpentry', dateCreated: '05/03/2023', status: 'Pending', address: '789 Maple St.',city: 'Kaunas', cost: 90, notes: 'Spinta Denver, balta Prekės ID: 6697566'  },
  { jobCategory: 'Plumbing', dateCreated: '05/01/2023', status: 'Completed', address: '123 Main St.',city: 'Vilnius', cost: 80, notes: 'Skalbimo mašina pakraunama iš priekio Ströme WM1510/01', started: '15/05/2023 12:10' },
  { jobCategory: 'Electrical', dateCreated: '05/02/2023', status: 'In Progress', address: '456 Oak Ave.',city: 'Vilnius', cost: 220, notes: 'Televizorius Sony KD50X72KPAEP Android LED TV, 50" (~127 cm)', started: '15/05/2023 12:00' },
  { jobCategory: 'Carpentry', dateCreated: '05/03/2023', status: 'Pending', address: '789 Maple St.',city: 'Klaipėda', cost: 130, notes: 'Spinta Denver, balta Prekės ID: 6697566'  },
];
...
const MarketPlaceScreen: React.FC = () => {
  ...
  const HandleTaskNavigation = (task: Task) =>{
    ...
    navigation.navigate('MarketPlaceTask', {Task: task });
  }
    ...
    <View style={[styles.container,  {backgroundColor:theme.colors.background} ]}>
      ...
      <View style={styles.content}>
        <View style={styles.header}>
          <Text style={styles.title}>{t('Task MarketPlace')}</Text>
